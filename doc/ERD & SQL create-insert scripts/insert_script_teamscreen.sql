...
INSERT INTO `teamscreen`.`member` (`name`, `username`, `destination`, `drink_preference`, `working_days`, `Team_id`) VALUES ('Jantje Smit', 'jantje', 'Amsterdam', 'koffie', 'maandag,dinsdag,woensdag,donderdag', 1);
INSERT INTO `teamscreen`.`member` (`name`, `username`, `destination`, `drink_preference`, `working_days`, `Team_id`) VALUES ('Trijntje Oosterhuis', 'trijntje', 'Den Haag', 'thee', 'dinsdag,woensdag', 2);
